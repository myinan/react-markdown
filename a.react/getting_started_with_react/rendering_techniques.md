...
*Note: We will use `props` here, and you will learn more about them in a future lesson. For now, you just need to know that `props` are arguments that are passed into components. We will just be writing a short implementation.*
...
If none of those checks passed, then we have the data we need to render the list successfully. 
...
**Q1.** How do you render a list of elements/components in JSX?
...
**Q2.** What are the ways you could render UI conditionally?
...
3. Other ways to render conditionally (use if, if/else, or switch):
...
**Q3.** How would you conditionally return JSX?
